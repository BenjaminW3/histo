window.addEventListener('load', function () {
	...
	// Note that this is only an approximation of the CMYK color space. For proper CMYK color space conversion one needs to implement support for color profiles.
